...
const signInWithGooglePopup = () => signInWithPopup(auth, provider).then(async (result) => {
  console.log('inside a then', result)
  const res = await axios.post(`${BACKEND_URL}/api/v1/user/addgooglesigninuser`, {
    data: {
      ...
      <div className="w-full min-h-min justify-center align-middle flex pb-64 pt-24">
        <Card className="w-[650px]">
          ...
          <CardContent className="flex justify-center">
            <Button className="flex" onClick={logGoogleUser}>
